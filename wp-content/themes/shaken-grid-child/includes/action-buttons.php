...
<div class="actions<?php if ( ! comments_open() ){ echo ' comments-hidden'; } ?>">
    ...
    <div class="share-container">
        <div class="share-icons">
            ...
            <a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&media=<?php if(function_exists('the_post_thumbnail')) echo wp_get_attachment_url(get_post_thumbnail_id()); ?>&description=<?php echo urlencode(get_the_title()); ?>" class="pin-it-button" count-layout="horizontal">
                <img src="<?php echo get_template_directory_uri(); ?>/images/pinterest-ic-16.png" alt="Share on Tumblr" />
            </a>
