...
<!--    <a href="#" class="filter-btn"><span><?php _e('Categories', 'shaken'); ?></span></a> -->
      	<ul>
   			<li><a href="#" data-filter="*"><?php _e('All Categories', 'shaken'); ?></a></li>
            <li><a href="#" data-filter=".sleepover">National Cookie Sleepover</a></li>
        	<?php
         	$args=array(
          		'orderby' => 'name',
                'exclude' => 6,
